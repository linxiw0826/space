...
def load_and_preprocess_images(image_path_list, mode="crop", target_size=512):
    """
...
def prepare_image_inputs(image, image_processor):
    """
    Prepare image inputs for geometry encoder.
    ...
    Returns:
        dict: Contains pixel_values, image_grid_thw, and geometry_encoder_inputs
    """
