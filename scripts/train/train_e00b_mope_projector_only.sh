...
if [ "${MODEL_SIZE}" = "4b" ]; then
    ...
    output_dir="${OUTPUT_DIR:-${SPACE_OUTPUT_ROOT}/train/e00b_mope_projector_only_4b}"
    run_name="space_e00b_mope_projector_only_4b_lr1e-5"
    RESUME_FROM_CHECKPOINT=${RESUME_FROM_CHECKPOINT:-${SPACE_OUTPUT_ROOT}/train/e00b_mope_projector_only_4b/checkpoint-4000}
elif [ "${MODEL_SIZE}" = "8b" ]; then
    batch_size=1
    grad_accum_steps=16
    # 8B requires ZeRO-3 to fit on 8×H20 GPUs.
    ...
    output_dir="${OUTPUT_DIR:-${SPACE_OUTPUT_ROOT}/train/e00b_mope_projector_only_8b}"
