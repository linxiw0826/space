...
QUARTER_MANIFEST="${VSI590K_SPAR_ANN_QUARTER:-/data2/wlx/data/vsi590k_processed/vsi590k_spar_590k_quarter_stratified.json}"
...
export SPACE_ROOT VSI590K_SPAR_ANN="${QUARTER_MANIFEST}" LOG_PREFIX=baseline_quarter_4b
