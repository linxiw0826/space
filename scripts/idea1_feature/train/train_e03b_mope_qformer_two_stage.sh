...
if [ "${MODEL_SIZE}" = "4b" ]; then
    ...
    GUIDE_CKPT_PATH=${GUIDE_CKPT_PATH:-${SPACE_OUTPUT_ROOT}/train/e00c_mope_qformer_projector_only_4b}
    output_dir="${OUTPUT_DIR:-${SPACE_OUTPUT_ROOT}/train/e03b_mope_qformer_two_stage_4b}"
    run_name="space_e03b_mope_qformer_two_stage_4b_lr1e-5"
    RESUME_FROM_CHECKPOINT=${RESUME_FROM_CHECKPOINT:-${SPACE_OUTPUT_ROOT}/train/e03b_mope_qformer_two_stage_4b/checkpoint-4000}
    ...
    GUIDE_CKPT_PATH=${GUIDE_CKPT_PATH:-${SPACE_OUTPUT_ROOT}/train/e00c_mope_qformer_projector_only_8b}
    output_dir="${OUTPUT_DIR:-${SPACE_OUTPUT_ROOT}/train/e03b_mope_qformer_two_stage_8b}"
