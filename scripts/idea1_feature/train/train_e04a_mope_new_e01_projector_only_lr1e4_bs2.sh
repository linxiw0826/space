...
# training the fresh projector with peak LR 1e-4.
# 2 samples/GPU x 4 GPUs x 6 accumulation steps = 48 samples/update.
# Use a separate output directory; never resume the unstable LR=1e-3 run.
...
OUTPUT_DIR="${OUTPUT_DIR:-${SPACE_OUTPUT_ROOT:-/data2/wlx/output}/train/e04a_mope_new_e01_projector_only_lr1e4_bs2_4b}"
MOPE_NEW_EXPERIMENT=e04a-new
export CUDA_VISIBLE_DEVICES NPROC_PER_NODE PER_DEVICE_TRAIN_BATCH_SIZE GRAD_ACCUM
export LEARNING_RATE MOPE_PROJECTOR_DIAG MOPE_PROJECTOR_DIAG_EVERY_FORWARDS
