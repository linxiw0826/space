...
# The verified default launch uses physical GPUs 1,2,4.  Keep the original
# effective global batch at 48: 2 samples/GPU x 3 GPUs x 8 accumulation steps.
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1,2,4}"
