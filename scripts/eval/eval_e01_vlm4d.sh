#!/bin/bash
# =============================================================================
# Evaluate E-01 (GUIDE fine-tuned on VSI-590K, no MoPE) checkpoint on VLM4D
...
#
# Usage:
#   bash eval_e01_vlm4d.sh [CKPT_PATH] [EXP_NAME]
#
...
case "${MODEL_SIZE}" in
    4b)
        ...
        DEFAULT_EXP_NAME="e01_guide_4b_vlm4d"
        ;;
    8b)
        DEFAULT_CKPT_PATH="${SPACE_OUTPUT_ROOT}/train/e01_guide_8b"
        DEFAULT_EXP_NAME="e01_guide_8b_vlm4d"
        ;;
    *)
...
# Status output
# ---------------------------------------------------------------------------
echo "=== VLM4D Evaluation (E-01 GUIDE fine-tune, no MoPE) ==="
