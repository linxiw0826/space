#!/bin/bash
# =============================================================================
# Evaluate E-03a (CrossAttn two-stage) on VLM4D
...
case "${MODEL_SIZE}" in
    4b)
        DEFAULT_CKPT_PATH="${SPACE_OUTPUT_ROOT}/train/e03a_mope_crossattn_two_stage_4b"
        DEFAULT_EXP_NAME="e03a_mope_crossattn_two_stage_4b_vlm4d"
        ;;
    8b)
        DEFAULT_CKPT_PATH="${SPACE_OUTPUT_ROOT}/train/e03a_mope_crossattn_two_stage_8b"
        DEFAULT_EXP_NAME="e03a_mope_crossattn_two_stage_8b_vlm4d"
        ;;
    *)
...
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_DIR}/e03a_vlm4d_${MODEL_SIZE}_$(date +%Y%m%d_%H%M%S).log"
...
# Status output
# ---------------------------------------------------------------------------
echo "=== VLM4D Evaluation (E-03a MoPE CrossAttn two-stage) ==="
