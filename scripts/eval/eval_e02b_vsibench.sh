#!/bin/bash
# =============================================================================
# Evaluate E-02b (MoPE concat fusion) checkpoint on VSIBench
#
# Usage:
#   bash eval_e02b_vsibench.sh [CKPT_PATH] [EXP_NAME]
#
# Arguments (optional — derived from MODEL_SIZE when omitted):
#   CKPT_PATH  — path to the E-02b checkpoint directory to evaluate
...
case "${MODEL_SIZE}" in
    4b)
        DEFAULT_CKPT_PATH="/home/nvme03/wlx/Space_sensing/output/train/e02b_mope_concat_4b"
        DEFAULT_EXP_NAME="e02b_mope_concat_4b"
        ;;
    8b)
        DEFAULT_CKPT_PATH="/home/nvme03/wlx/Space_sensing/output/train/e02b_mope_concat_8b"
        DEFAULT_EXP_NAME="e02b_mope_concat_8b"
        ;;
    *)
...
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_DIR}/e02b_vsibench_${MODEL_SIZE}_$(date +%Y%m%d_%H%M%S).log"
...
# Status output
# ---------------------------------------------------------------------------
echo "=== VSIBench Evaluation (E-02b MoPE concat fusion) ==="
