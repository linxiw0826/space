...
case "${MODEL_SIZE}" in
    4b)
        DEFAULT_CKPT_PATH="${SPACE_OUTPUT_ROOT}/train/e00c_mope_qformer_projector_only_4b"
        DEFAULT_EXP_NAME="e00c_mope_qformer_projector_only_4b"
        ;;
    8b)
        DEFAULT_CKPT_PATH="${SPACE_OUTPUT_ROOT}/train/e00c_mope_qformer_projector_only_8b"
