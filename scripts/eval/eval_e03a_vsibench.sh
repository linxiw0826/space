#!/bin/bash
# =============================================================================
# Evaluate E-03a (CrossAttn two-stage) on VSIBench
...
case "${MODEL_SIZE}" in
    4b)
        DEFAULT_CKPT_PATH="/home/nvme03/wlx/Space_sensing/output/train/e03a_mope_crossattn_two_stage_4b"
        DEFAULT_EXP_NAME="e03a_mope_crossattn_two_stage_4b"
        ;;
    8b)
        DEFAULT_CKPT_PATH="/home/nvme03/wlx/Space_sensing/output/train/e03a_mope_crossattn_two_stage_8b"
        DEFAULT_EXP_NAME="e03a_mope_crossattn_two_stage_8b"
        ;;
    *)
...
# Status output
# ---------------------------------------------------------------------------
echo "=== VSIBench Evaluation (E-03a MoPE CrossAttn two-stage) ==="
